...
def evaluate_current_solution() :
    ...
    for i in range( 1, 101 ) :
        process = Popen( [ 'java', 'TrucksAndCouriersVis', '-exec', './/x64//Release//TrucksAndCouriers.exe', '-seed', str( i ) ], stdout = PIPE )
...
save_solution( 'worse5', scores )

compare_scores( 'worse2', 'worse5' )